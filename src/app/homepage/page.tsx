...
// Floating logo data - fixed to avoid hydration mismatch
const floatingLogos = [
  { id: 'fl-0',  size: 28, left: 5,  top: 8,  rotation: 15,  duration: 22, delay: 0,    opacity: 0.06 },
  { id: 'fl-1',  size: 20, left: 18, top: 25, rotation: -30, duration: 28, delay: -5,   opacity: 0.04 },
  { id: 'fl-2',  size: 42, left: 35, top: 12, rotation: 45,  duration: 35, delay: -10,  opacity: 0.07 },
  { id: 'fl-3',  size: 24, left: 52, top: 40, rotation: -20, duration: 25, delay: -3,   opacity: 0.05 },
  { id: 'fl-4',  size: 50, left: 70, top: 7,  rotation: 60,  duration: 40, delay: -15,  opacity: 0.08 },
  { id: 'fl-5',  size: 32, left: 85, top: 30, rotation: -45, duration: 30, delay: -8,   opacity: 0.06 },
  { id: 'fl-6',  size: 22, left: 92, top: 60, rotation: 25,  duration: 27, delay: -12,  opacity: 0.05 },
  { id: 'fl-7',  size: 38, left: 75, top: 75, rotation: -15, duration: 33, delay: -2,   opacity: 0.07 },
  { id: 'fl-8',  size: 26, left: 55, top: 85, rotation: 50,  duration: 38, delay: -18,  opacity: 0.04 },
  { id: 'fl-9',  size: 44, left: 30, top: 70, rotation: -35, duration: 32, delay: -7,   opacity: 0.09 },
  { id: 'fl-10', size: 20, left: 12, top: 55, rotation: 10,  duration: 24, delay: -20,  opacity: 0.05 },
  { id: 'fl-11', size: 36, left: 48, top: 92, rotation: -55, duration: 42, delay: -4,   opacity: 0.06 },
];
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        /* Floating Logo Animation - Cinematic Drift & Breathe */
        @keyframes floatingLogo {
          ...
          15% {
            transform: translate(8px, -12px) rotate(6deg) scale(1.05);
            opacity: 0.7;
          }
          30% {
            transform: translate(15px, -5px) rotate(-4deg) scale(0.95);
            opacity: 0.5;
          }
          45% {
            transform: translate(6px, 10px) rotate(8deg) scale(1.08);
            opacity: 0.8;
          }
          60% {
            transform: translate(-8px, 14px) rotate(-6deg) scale(0.97);
            opacity: 0.55;
          }
          75% {
            transform: translate(-14px, 4px) rotate(3deg) scale(1.03);
            opacity: 0.65;
          }
          90% {
        ...
        @media (max-width: 768px) {
          ...
          /* Mobile: Reduced motion & opacity for floating logos */
          @keyframes floatingLogo {
            0% {
              transform: translate(0px, 0px) rotate(0deg) scale(1);
              opacity: 0.25;
            ...
            40% {
              transform: translate(5px, -6px) rotate(4deg) scale(1.03);
              opacity: 0.45;
            }
            70% {
              transform: translate(-4px, 7px) rotate(-3deg) scale(0.97);
              opacity: 0.3;
            }
            100% {
              transform: translate(0px, 0px) rotate(0deg) scale(1);
